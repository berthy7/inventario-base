...
$('#fkempresa').selectpicker({
    size: 10,
    liveSearch: true,
    liveSearchPlaceholder: 'Buscar empresa',
...
function set_enable(e) {
    ...
    if (!b) {
        cb_title = "¿Está seguro de que desea dar de baja la sucursal?"
        cb_text = ""
        cb_type = "warning"
    } else {
        cb_title ="¿Está seguro de que desea dar de alta la sucursal?"
        cb_text = ""
        cb_type = "info"
    }
...
function delete_item(e) {
    Swal.fire({
        icon: "warning",
        title: "¿Está seguro de que desea eliminar permanentemente la sucursal?",
        text: "",
        showCancelButton: true,
        allowOutsideClick: false,
        confirmButtonColor: '#1565c0',
