...
class Serializable:
    ...
    def __init__(self, **properties):
        ...
        Returns
        -------
        objeto | Retornará un objeto instanciado de la clase que lo heredó.
        """
    ...
    def get_dict(self, way=None):
        ...
        Parameters
        ----------
        way : dict | Este diccionario definirá que relaciones y subrelaciones serán mapeadas o tomadas en cuenta.
        """
        if way is None:
            way = self.way
        result = dict()
